# -*- coding: utf-8 -*-
"""
Created on Wed Sep 29 11:44:21 2021
...
def synthetic(save_locate, org_img, pre_img, number):
    
    #保存ファイルの作成
    print("ディレクトリ名:"+ str(number) + "を作成します")
    ...
    for p in range(len(pre_img)): 
     ...
     cv2.imwrite(locate + 'result' + "/" +str(number) + "/" + str(p) + ".bmp", rgb_pre_img)
