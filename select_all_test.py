# -*- coding: utf-8 -*-
"""
Created on Tue Sep 28 15:30:41 2021
...
file1 = tkinter.filedialog.askopenfilenames(filetypes = fTyp,initialdir = iDir)
if len(file1) == 0:
...
for i in range(len(file1)):
    org_tmp = cv2.imread (file1[i])
    org_img.append(cv2.resize(org_tmp,dsize=(512,512))) #リサイズ
...
#画像合成関数に飛ぶ 
#msk_img = 255 - msk_img
Synthetic_all.synthetic(model_locate, org_img, pre_img,number)
